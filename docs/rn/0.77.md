...
- Podman now preserves an image's default entrypoint and command when a topology leaves `entrypoint` and `cmd` unset, matching Docker's behavior. Thanks @orrious #3278
