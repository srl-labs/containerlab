...
In this release, containerlab will automatically create an allowing rule in the `DOCKER-USER` chain to allow external systems to reach containerlab nodes. Read more about this feature in [our docs](../manual/network.md#access-from-external-hosts).
