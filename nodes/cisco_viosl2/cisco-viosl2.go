...
var (
	kindnames          = []string{"cisco_viosl2", "vr-viosl2", "vr-cisco_viosl2"}
...
type vrViosL2 struct {
	clabnodes.VRNode
}

func (n *vrViosL2) Init(cfg *clabtypes.NodeConfig, opts ...clabnodes.NodeOption) error {
	// Init VRNode
