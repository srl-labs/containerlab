...
func (c *CLab) createNodeCfg( //nolint: funlen
	...
	nodeCfg := &clabtypes.NodeConfig{
		...
		VeloVcoFqdn:      c.Config.Topology.GetVcoFqdn(nodeName),
		VeloApiToken:     c.Config.Topology.GetVcoApiToken(nodeName),
		VeloEnterpriseId: c.Config.Topology.GetVcoEnterpriseId(nodeName),
		VeloEdgeId:       c.Config.Topology.GetVcoEdgeId(nodeName),
