...
Containerlab automatically assigns each IOL node process ID which is used to generate the base MAC address for the system. 
...
See the [Cisco IOL multinode lab example](../../lab-examples/cisco_iol.md#multinode-labs-and-cisco-iol-l2).
///
