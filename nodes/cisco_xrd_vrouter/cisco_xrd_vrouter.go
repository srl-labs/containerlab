...
var (
	kindNames          = []string{"cisco_xrd_vrouter"}
...
func Register(r *clabnodes.NodeRegistry) {
	...
	r.Register(kindNames, func() clabnodes.Node {
		return new(cisco_xrd_vrouter)
	}, nrea)
}

type cisco_xrd_vrouter struct {
	clabnodes.VRNode
}

func (n *cisco_xrd_vrouter) Init(cfg *clabtypes.NodeConfig, opts ...clabnodes.NodeOption) error {
	// Init VRNode
