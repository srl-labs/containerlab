...
func ceosPostDeploy(ctx context.Context, c *CLab, node *types.NodeBase, lworkers uint) error {
...
func initCeosNode(c *CLab, nodeCfg NodeConfig, node *types.NodeBase, user string, envs map[string]string) error {
	var err error
...
func (c *CLab) createCEOSFiles(node *types.NodeBase) error {
