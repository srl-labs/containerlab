...
func (n *sros) setCustomPrompt(tplData *srosTemplateData) {
...
func (n *sros) currentPrompt(ctx context.Context) (string, error) {
	cmd, _ := exec.NewExecCmdFromString(`tail /home/sros/cf3:/bootlog.txt`)
