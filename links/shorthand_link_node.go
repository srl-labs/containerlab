...
func NewShorthandLinkNode(shortname, nspath string) *ShorthandLinkNode {
...
func (n *ShorthandLinkNode) AddNetlinkLinkToContainer(_ context.Context, link netlink.Link, f func(ns.NetNS) error) error {
...
func (*ShorthandLinkNode) GetLinkEndpointType() LinkEndpointType {
