...
- Podman now honors `network-mode: none`, letting nodes opt out of management-network attachment while still preserving explicit host entries. Thanks @orrious #3279
