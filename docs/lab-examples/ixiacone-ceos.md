...
| **Name**                      | srlceos01                                                                           |
| **Version information**[^2]   | `containerlab:0.24.2`, `ixia-c-one:0.0.1-2610`, `ceos:4.25.0F`, `docker-ce:20.10.12`|

## Description
A lab consists of an Ixia-c-one node connected with Arista cEOS via a point-to-point ethernet link. Both nodes are also connected with their management interfaces to the `containerlab` docker network.
<TBD: the content as of now is from srl-ceos lab-example - needs to be updated; diagrame update - how?>
...
## Use cases
This lab allows users to launch basic interoperability scenarios between Ixia-c-one and Arista cEOS operating systems.
<TBD: the content as of now is from srl-ceos lab-example - needs to be updated>
